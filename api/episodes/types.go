...
type WaveformStatus struct {
	...
	Data     *WaveformData `json:"data,omitempty" swaggerignore:"true"` // Only present when status="ok"
}
...
// EnhancedEpisodeResponse represents an episode with embedded waveform status
